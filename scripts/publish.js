...
async function publish() {
  try {
    console.log('📦 light-mem Marketplace Release Tool\n');
...
https://github.com/Ronald-Estacion_NordTech/light-mem"`);
    ...
    console.log(`\n🏷️  Tag: https://github.com/Ronald-Estacion_NordTech/light-mem/releases/tag/v${newVersion}`);
