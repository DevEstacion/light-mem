...
const DB_PATH = path.join(os.homedir(), '.light-mem', 'light-mem.db');
const SETTINGS_PATH = path.join(os.homedir(), '.light-mem', 'settings.json');
const settings = SettingsDefaultsManager.loadFromFile(SETTINGS_PATH);
const OBSERVATION_LIMIT = parseInt(settings.LIGHT_MEM_CONTEXT_OBSERVATIONS, 10) || 50;
