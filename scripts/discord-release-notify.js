...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/Ronald-Estacion_NordTech/light-mem';

  const payload = {
    embeds: [
      {
        title: `🚀 light-mem ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.light-mem.ai](https://github.com/Ronald-Estacion_NordTech/light-mem)',
            inline: true,
          },
        ],
        footer: {
          text: 'light-mem • Persistent memory for Claude Code',
        },
