...
function resolveDbPath(): string {
  ...
  return join(dataDir, 'light-mem.db');
}
...
Notes:
  Operates directly on ~/.light-mem/light-mem.db (or \$LIGHT_MEM_DATA_DIR).
...
`);
  ...
  console.log(clearAll
    ? '\n=== Light-Mem Queue Clearer (ALL) ===\n'
    : '\n=== Light-Mem Queue Clearer (Processing) ===\n');
