...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for light-mem
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for light-mem using the Claude Agent SDK.
...
async function main() {
  ...
  console.log(`   Light-mem: v${diagnostics.versions.nordMem}`);
  ...
  const githubUrl = `https://github.com/Ronald-Estacion_NordTech/light-mem/issues/new?title=${encodedTitle}&body=${encodedBody}`;
