...
- [ ] I searched [existing issues](https://github.com/Ronald-Estacion_NordTech/light-mem/issues) and confirmed this is not a duplicate
...
**Plugin Paths:**
- **macOS/Linux**: `~/.claude/plugins/marketplaces/light-mem`
- **Windows**: `%USERPROFILE%\.claude\plugins\marketplaces\light-mem`
...
- **Path**: `~/.light-mem/logs/worker-YYYY-MM-DD.log`
- **Example**: `~/.light-mem/logs/worker-2025-12-14.log`
