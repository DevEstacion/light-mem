...
const STORAGE_KEY = 'light-mem-welcome-dismissed-v3';
const EXPLAINER_URL = '/api/onboarding/explainer';
const DOCS_URL = 'https://github.com/Ronald-Estacion_NordTech/light-mem';
    ...
    <div className="welcome-modal-backdrop" onClick={handleDismiss}>
      ...
      >
        ...
        <header className="welcome-modal-header">
          <img className="welcome-modal-logo" src="light-mem-logo-stylized.png" alt="" width="96" height="96" />
          <h2 id="welcome-modal-title">Welcome to light-mem</h2>
