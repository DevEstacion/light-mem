      ...
      <div className="context-settings-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="settings-column">
            ...
            >
              ...
              >
                <input
                  ...
                  min="1"
                  max="200"
                  value={formState.LIGHT_MEM_CONTEXT_OBSERVATIONS || '50'}
                  onChange={(e) => updateSetting('LIGHT_MEM_CONTEXT_OBSERVATIONS', e.target.value)}
                />
              </FormField>
              <FormField
                label="Sessions"
              ...
              >
                <input
                  ...
                  min="1"
                  max="50"
                  value={formState.LIGHT_MEM_CONTEXT_SESSION_COUNT || '10'}
                  onChange={(e) => updateSetting('LIGHT_MEM_CONTEXT_SESSION_COUNT', e.target.value)}
                />
              </FormField>
            </CollapsibleSection>
              ...
              <div className="display-subsection">
                ...
                >
                  <input
                    ...
                    min="0"
                    max="20"
                    value={formState.LIGHT_MEM_CONTEXT_FULL_COUNT || '5'}
                    onChange={(e) => updateSetting('LIGHT_MEM_CONTEXT_FULL_COUNT', e.target.value)}
                  />
                </FormField>
                <FormField
                  label="Field"
                ...
                >
                  <select
                    value={formState.LIGHT_MEM_CONTEXT_FULL_FIELD || 'narrative'}
                    onChange={(e) => updateSetting('LIGHT_MEM_CONTEXT_FULL_FIELD', e.target.value)}
                  >
              ...
              <div className="display-subsection">
                ...
                <div className="toggle-group">
                  <ToggleSwitch
                    ...
                    checked={formState.LIGHT_MEM_CONTEXT_SHOW_READ_TOKENS === 'true'}
                    onChange={() => toggleBoolean('LIGHT_MEM_CONTEXT_SHOW_READ_TOKENS')}
                  />
                  <ToggleSwitch
                    id="show-work-tokens"
                    label="Work investment"
                    description="Tokens spent creating this observation"
                    checked={formState.LIGHT_MEM_CONTEXT_SHOW_WORK_TOKENS === 'true'}
                    onChange={() => toggleBoolean('LIGHT_MEM_CONTEXT_SHOW_WORK_TOKENS')}
                  />
                  <ToggleSwitch
                    id="show-savings-amount"
                    label="Savings"
                    description="Total tokens saved by reusing context"
                    checked={formState.LIGHT_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT === 'true'}
                    onChange={() => toggleBoolean('LIGHT_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT')}
                  />
                </div>
              </div>
            </CollapsibleSection>
            ...
            <CollapsibleSection
              title="Advanced"
              description="Model selection and session context"
              defaultOpen={false}
            >
              <FormField
                label="Claude Model"
              ...
              >
                <select
                  value={formState.LIGHT_MEM_MODEL || 'haiku'}
                  onChange={(e) => updateSetting('LIGHT_MEM_MODEL', e.target.value)}
                >
              ...
              >
                <input
                  ...
                  min="1024"
                  max="65535"
                  value={formState.LIGHT_MEM_WORKER_PORT || '37777'}
                  onChange={(e) => updateSetting('LIGHT_MEM_WORKER_PORT', e.target.value)}
                />
              </FormField>
              ...
              <div className="toggle-group" style={{ marginTop: '12px' }}>
                <ToggleSwitch
                  ...
                  checked={formState.LIGHT_MEM_CONTEXT_SHOW_LAST_SUMMARY === 'true'}
                  onChange={() => toggleBoolean('LIGHT_MEM_CONTEXT_SHOW_LAST_SUMMARY')}
                />
                <ToggleSwitch
                  id="show-last-message"
                  label="Include last message"
                  description="Add previous session's final message"
                  checked={formState.LIGHT_MEM_CONTEXT_SHOW_LAST_MESSAGE === 'true'}
                  onChange={() => toggleBoolean('LIGHT_MEM_CONTEXT_SHOW_LAST_MESSAGE')}
                />
              </div>
            </CollapsibleSection>
          </div>
