      ...
      <div className="header-main">
        <h1>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            <img src="light-mem-logomark.png" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
            {queueDepth > 0 && (
          ...
          <span className="logo-text">light-mem</span>
        </h1>
      </div>
      <div className="status">
        <a
          href="https://github.com/Ronald-Estacion_NordTech/light-mem"
          target="_blank"
        ...
        <GitHubStarsButton username="light-mem" repo="light-mem" />
        <select
          value={currentFilter}
