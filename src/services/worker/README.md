...
The Worker Service is an Express HTTP server that handles all light-mem operations. It runs on port 37777 (configurable via `LIGHT_MEM_WORKER_PORT`) and is managed by PM2.
