import { Database, type SQLQueryBindings } from './node-sqlite-compat.js';
...
export class SessionStore {
  ...
  /**
   * Migration 35: local vector store table (one row per embedded document,
   * mirroring the old Chroma collection's 1-to-many doc-id scheme). See
   * LocalVectorStore. Idempotent — safe on every boot.
   */
