...
// turns to a single shared markdown file (default ~/.light-mem/STANDUP.md).
...
//   --file <path>   | STANDUP_FILE  | ~/.light-mem/STANDUP.md
...
function defaultFile() {
  return (
    ...
    join(homedir(), ".light-mem", "STANDUP.md")
  );
}
...
file defaults to ~/.light-mem/STANDUP.md; override with --file or STANDUP_FILE.`;
