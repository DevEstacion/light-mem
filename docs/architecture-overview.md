# light-mem Architecture Overview
...
+-----------------------------------------------------------+
|  Storage Layer                                            |
|  +-- SQLite (light-mem.db) -- structured data            |
...
|-------|---------|-------------|---------|
| Setup | version-check.js | Sub-100ms version-marker check; prompts `npx light-mem repair` on mismatch | 60s |
