...
description: "Configure Light-Mem behavior and language with the Mode System"
---

# Modes & Languages

Light-Mem uses a flexible **Mode System** to adapt its behavior, observation types, and output language. This allows you to switch between different workflows (like coding vs. email investigation) or languages without reinstalling the plugin.
...
Set the active mode using the `LIGHT_MEM_MODE` setting in `~/.light-mem/settings.json`:
