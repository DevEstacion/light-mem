...
description: "Learn how Light-Mem works automatically in the background"
---

# Getting Started with Light-Mem

## Automatic Operation

Light-Mem works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, light-mem captures it:
...
Context is stored in SQLite database at `~/.light-mem/light-mem.db`.
...
Light-Mem supports sessions that span multiple user prompts:
...
Light-Mem provides MCP tools for querying your project history. Simply ask naturally:
