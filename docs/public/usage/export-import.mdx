...
description: "Share knowledge across light-mem installations with duplicate prevention"
---

# Memory Export/Import Scripts

Share your light-mem knowledge with other users! These scripts allow you to export specific memories (observations, sessions, summaries, and prompts) and import them into another light-mem installation.
...
```bash
# Export only light-mem project memories
npx tsx scripts/export-memories.ts "bugfix" bugfixes.json --project=light-mem
...
```
❌ Database not found at: /Users/you/.light-mem/light-mem.db
```

**Solution:** Make sure light-mem is installed and has been run at least once.
