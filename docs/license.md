...
engine, Light-Mem Server, CLI, SDKs, adapters, MCP tools, schemas, tests,
...
Light-Mem is intended to be embedded broadly inside developer tools, local
...
Light-Mem Server v0.1 does not ship hosted cloud, team sync, enterprise
